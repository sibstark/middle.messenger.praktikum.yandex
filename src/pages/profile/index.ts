...
import {
  FormControl, Button, EmptyFormControl, Modal
} from "@components";
...
<input type="file" name="avatar" style="display: none" />`;
  ...
  const renderedUpdateControls = concatArrayTemplates(
    updateProfileControls.map((control) => FormControl(control))
  );
  const renderedChangePassControls = concatArrayTemplates(
